...
public class TrueOrFalseMultiplyActivity extends AppCompatActivity implements Adclick{
    ...
    private void showIntAd(){
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                methods.showInd(TrueOrFalseMultiplyActivity.this, TrueOrFalseMultiplyActivity.this);
...
//                    });
//
//                    mInterstitialAd.show(TrueOrFalseMultiplyActivity.this);
//                }
