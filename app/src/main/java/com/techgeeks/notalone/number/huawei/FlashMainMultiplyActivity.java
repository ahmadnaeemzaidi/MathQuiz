...
public class FlashMainMultiplyActivity extends AppCompatActivity implements Adclick{
    ...
    private void showIntAd(){
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                methods.showInd(FlashMainMultiplyActivity.this, FlashMainMultiplyActivity.this);
