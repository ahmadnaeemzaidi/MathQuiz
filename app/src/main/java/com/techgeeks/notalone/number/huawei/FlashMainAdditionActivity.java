...
public class FlashMainAdditionActivity extends AppCompatActivity implements Adclick{
...
//        });
    ...
    private void showIntAd(){
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                methods.showInd(FlashMainAdditionActivity.this, FlashMainAdditionActivity.this);
